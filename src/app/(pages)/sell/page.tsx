      ...
      <section className="block bg-white py-[100px] dark:bg-[#000]">
        <div className="max-w-[1228px] mx-auto px-[15px]">
          <div className="mx-auto flex flex-col gap-[25px] text-center md:w-[800px]">
            ...
            <p className="text-[16px] leading-[20px] text-[#60646c] dark:text-white">
            ...
            <div className="flex justify-center">
              <div className="flex gap-[20px]">
                ...
                <button type="button" className=' rounded-md text-[16px] py-[8px] px-[30px] text-center w-[160px] capitalize bg-[#ededed] text-[#000] dark:bg-slate-800 dark:text-white hover:bg-[#ededed] dark:hover:bg-slate-600'>discover</button>
              </div>
            </div>
          </div>
        </div>
      </section>
      <section className="block bg-[#ededed] dark:bg-slate-900 py-[100px] ">
        <div className="max-w-[1228px] mx-auto px-[15px]">
          <div className="flex flex-col items-center gap-[30px]">
            <div className="flex justify-center">
              <div className="flex flex-col gap-4 text-center md:w-[600px]">
                ...
                <p className="text-[16px] text-[#5b5e61] dark:text-[#b1b1b1]">
                ...
                <div className="grid w-full grid-cols-1 md:grid-cols-3 gap-[15px]">
                  <div className="flex flex-col gap-[15px] rounded-lg bg-white p-[20px] shadow dark:bg-slate-900">
                    <div className="flex items-center gap-3">
                      ...
                      <IconCoin stroke={2} className='text-black dark:text-white' />
                      </div>
                    ...
                    <div className="flex flex-col gap-4">
                      <div className="flex gap-2">
                        ...
                        <h6 className="text-[#5b5e61] dark:text-[#b1b1b1]">Commission-free trading</h6>
                      </div>
                      <div className="flex gap-2">
                        <IconCircleCheck stroke={2} className="text-[#000] dark:text-white" />
                        <h6 className="text-[#5b5e61] dark:text-[#b1b1b1]">Multi-layered encryption</h6>
                      </div>
                      <div className="flex gap-2">
                        <IconCircleCheck stroke={2} className="text-[#000] dark:text-white" />
                        <h6 className="text-[#5b5e61] dark:text-[#b1b1b1]">One tip every day</h6>
                      </div>
                      <div className="flex gap-2">
                        <IconCircleCheck stroke={2} className="text-[#000] dark:text-white" />
                        <h6 className="text-[#5b5e61] dark:text-[#b1b1b1]">Invest up to $l,500 each month</h6>
                      </div>
                    </div>
                  </div>
                  <div className="flex flex-col gap-[15px] rounded-lg bg-white p-[20px] shadow dark:bg-slate-900">
        ...
        <div className="max-w-[1228px] mx-auto px-[15px]">
          <div className="flex flex-col gap-[30px]">
            <div className="flex flex-col gap-2">
              ...
              <p className="text-[16px] text-[#5b5e61] dark:text-[#b1b1b1]">If you have anything else you want to ask, <Link href="/" className=" border-b border-black text-[#000]">reach out to us.</Link> </p>
            </div>
