                ...
                <div key={event.id} className="flex gap-6 py-6">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="text-xs/6 text-zinc-600">
                      $ {event.ticketsSold}/{event.ticketsAvailable} <b>Price</b>
                    </div>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                  <Badge className="max-sm:hidden" color={event.status === 'Purchase' ? 'lime' : 'zinc'}>
                    {event.status}
                  </Badge>
                  <Dropdown>
                    ...
                    <DropdownMenu anchor="bottom end">
                      ...
                      <DropdownItem>Git Access</DropdownItem>
                    </DropdownMenu>
                  </Dropdown>
                </div>
              </div>
